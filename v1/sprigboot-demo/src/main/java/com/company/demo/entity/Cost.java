...
public class Cost {
    ...
    public boolean equals(Object o) {
        ...
        return Double.compare(cost.base_cost, base_cost) == 0 &&
                ...
                Objects.equals(cretate_time, cost.cretate_time) &&
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, name, base_duration, base_cost, unit_cost, status, descr, cretate_time, start_time, cost_type);
    }
